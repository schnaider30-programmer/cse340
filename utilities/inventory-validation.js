...
validate.addInventoryRules = () => {
  return [
    ...
    body("inv_make")
      ...
      .bail()
      .isLength({ min: 3 })
      .withMessage("Make must have at least 3 characters"),
    ...
    body("inv_model")
      ...
      .bail()
      .isLength({ min: 3 })
      .withMessage("Model must have at least 3 characters"),
    ...
    body("inv_price")
      ...
      .withMessage("Price must a numeric value"),
    ...
    body("inv_year")
      ...
      .withMessage("Year must be a numeric value only")
      .bail()
      .isLength({ discreteLengths: 4 })
    ...
    body("inv_miles")
      ...
      .bail()
      .isNumeric({ no_symbols: true })
      .withMessage("Miles must be a numeric value only"),
    ...
    body("inv_color")
      ...
      .bail()
      .isAlpha()
      .withMessage("Color only accept alphabetic character"),
  ];
};
...
validate.maintenanceRules = () => {
  return [
    body("maint_type")
      ...
      .withMessage("Maintenance can only be between 3 and 50 characters.")
      .bail()
      .matches(/^[A-Za-z0-9\s\-]+$/)
      .withMessage("Maintenance type can only be letters, space, and hyphens."),

    body("maint_desc")
      .trim()
      .escape()
      .notEmpty()
      .withMessage("Please give a description for this maintenance.")
      .bail()
      .isLength({ max: 100 })
      .withMessage("Description can only be 100 characters long."),
    ...
    body("maint_cost")
      ...
      .withMessage("Cost must be a numeric value only.")
      .bail()
      .isLength({ max: 10 })
      .withMessage("Cost value is too long."),
    ...
    body("maint_responsible")
      ...
      .withMessage("Responsible name must be between 2 and 50 characters.")
      .bail()
      .matches(/^[a-zA-Z\s '-]+$/)
      .withMessage(
        "Responsible name can only contain letters, spaces, apostrophes, and hyphens.",
      ),
    ...
    body("maint_next_due_date")
      .trim()
      .notEmpty()
      .withMessage("Maintenance next scheduled date is required.")
      .bail()
      .isISO8601()
      .withMessage("Next due date must be a valid date in YYYY-MM-DD format."),

    body("inv_id")
      .trim()
      .notEmpty()
      .withMessage("Vehicle ID was not found.")
      .bail()
      .isInt()

...
ALTER TYPE public.account_type OWNER TO sce340db;
...
CREATE TABLE public.maintenance (
    maint_id integer NOT NULL GENERATED ALWAYS AS IDENTITY (INCREMENT 1 START 1 MINVALUE 1),
    inv_id integer NOT NULL,
    maint_type character varying(50) NOT NULL,
    maint_desc text NOT NULL,
    maint_cost numeric(10, 2) NOT NULL,
    maint_responsible character varying(50) NOT NULL,
    maint_date date NOT NULL,
    maint_next_due_date date NOT NULL,
    CONSTRAINT pk_maintenance PRIMARY KEY (maint_id),
    CONSTRAINT fk_inventory FOREIGN KEY (inv_id) REFERENCES public.inventory (inv_id) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE NOT VALID
);
ALTER TABLE IF EXISTS public.maintenance OWNER to sce340db;